...
public class Person {
    ...
    public String toString() {
        ...
        sb.append("bank='").append(bank.getAccount_year()).append(' ').append(bank.getNumber_card()).append(' ').append(bank.getManager_name()).append("',\n\t");
        sb.append("car='").append(car.getBrand()).append(' ').append(car.getColor()).append("',\n\t");
